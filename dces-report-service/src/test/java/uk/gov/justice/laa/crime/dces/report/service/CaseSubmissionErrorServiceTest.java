...
public class CaseSubmissionErrorServiceTest {
  ...
  void setUp() {
    dtoList = List.of(
        ...
        CaseSubmissionErrorDto.builder().maatId(2).concorContributionId(2).fdcId(2).title("error title 2").status(2).detail("error detail 2").creationDate(LocalDateTime.of(2025, 2, 2, 11, 10, 0)).build(),
